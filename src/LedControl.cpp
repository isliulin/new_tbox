...
int tbox_gpio_config()
{
    ...
    write(fd, SYSFS_GPIO_INPUT_VAL, sizeof(SYSFS_GPIO_OUTPUT_VAL));//
	//write(fd, SYSFS_GPIO_OUTPUT_VAL, sizeof(SYSFS_GPIO_OUTPUT_VAL)); new
    close(fd);
...
{
    file_w_s((const char*)"/sys/class/leds/led4g/trigger", (char*)"timer");
...
void lte_led_on()
{
    file_w_s((const char*)"/sys/class/leds/led4g/trigger", (char*)"none");
    file_w_s((const char*)"/sys/class/leds/led4g/brightness", (char*)"1");
...
{
    file_w_s((const char*)"/sys/class/leds/led4g/trigger", (char*)"none");
    file_w_s((const char*)"/sys/class/leds/led4g/brightness", (char*)"0");
...
{
    file_w_s((const char*)"/sys/class/leds/ledwifi/trigger", (char*)"timer");
    led_blink((const char*)"ledwifi/delay_on",light);
	led_blink((const char*)"ledwifi/delay_off",lightOff);
...
void wifi_led_on()
{
    file_w_s((const char*)"/sys/class/leds/ledwifi/trigger", (char*)"none");
    file_w_s((const char*)"/sys/class/leds/ledwifi/brightness", (char*)"1");
...
{
    file_w_s((const char*)"/sys/class/leds/ledwifi/trigger", (char*)"none");
    file_w_s((const char*)"/sys/class/leds/ledwifi/brightness", (char*)"0");
