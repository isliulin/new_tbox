...
#define	TAGID_LOCKDOOR			0x12
#define	TAGID_LOCKDOOR_Rep		0x72
#define	TAGID_OPENDOOR			0x13
#define	TAGID_OPENDOOR_Rep		0x73
#define	TAGID_POWEROFF			0x14
#define	TAGID_POWEROFF_Rep		0x74
#define	TAGID_POWERON			0x15
#define	TAGID_POWERON_Rep		0x75
#define	TAGID_CARFIND			0x16
#define	TAGID_CARFIND_Rep		0x76

#define	TAGID_NFC				0x17
#define	TAGID_NFC_Rep			0x77
...
//	uint8_t SK[6];                //SK
	...
	uint8_t Tbox_BLENAME[8];
	uint8_t Tbox_CARNAME[2];
	uint8_t Carid;
}TBox_Config_ST;
...
public:
	...
	uint16_t pack_LOCKDOOR_data(uint8_t *pData, int len);
	uint16_t pack_OPENDOOR_data(uint8_t *pData, int len);
	uint16_t pack_POWEROFF_data(uint8_t *pData, int len);
	uint16_t pack_POWERON_data(uint8_t *pData, int len);
	uint16_t pack_CARFIND_data(uint8_t *pData, int len);

	uint16_t Control_test(uint8_t tag);
