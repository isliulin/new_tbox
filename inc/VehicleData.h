...
#define CAR_GW_NODE_MISS    1
#define MODULE_SIGNAL_VALUE 	1
...
#if MODULE_SIGNAL_VALUE == 1
#define	MAX_SIGNCODE_TOTAL	33
#else
#define	MAX_SIGNCODE_TOTAL	29
#endif
...
typedef enum
{
	...
	ACPSIGNCODE_BatteryID		= 	3,	//蓄电池电压
	ACPSIGNCODE_CurrentSpeedID	= 	4,	//实时车速
	ACPSIGNCODE_CarDoorStateID	=	5,	//车门状态
	ACPSIGNCODE_CarLockState	=	6,	//车锁状态
	ACPSIGNCODE_SunroofStateID	=	7, //天窗状态
	ACPSIGNCODE_WindowStateID	=	8,	//车窗状态
	ACPSIGNCODE_CarlampStateID	=	9,	//车灯状态
	ACPSIGNCODE_EngineStateID	=	10,	//发动机状态
	ACPSIGNCODE_EngineSpeedID	=	11,	//发动机转速
	ACPSIGNCODE_GearStateID		=	12,	//档位信息
	ACPSIGNCODE_HandBrakeStateID=	13,	//手刹状态
	ACPSIGNCODE_PowerSupplyModeID=	14, //钥匙供电模式
	ACPSIGNCODE_PowerCellsStateID=	15, //动力电池状态
	ACPSIGNCODE_ChargeStateID	 =	16,//充电状态
	ACPSIGNCODE_ChargeConnetStateID	 =	17,//充电枪连接状态
	ACPSIGNCODE_BrakePedalSwitchID	 = 	18,//制动踏板开关
	ACPSIGNCODE_RemainderRangeID	 = 	19,//剩余续航里程
	ACPSIGNCODE_SafetyBeltID	=	20,	//安全带状态
	ACPSIGNCODE_MotorWorkStateID	 = 	21,//电机工作状态	
	ACPSIGNCODE_MotorSpeedID	=	22,	//电动机转速
	ACPSIGNCODE_PowerdID	    =	23,	//动力状态
	ACPSIGNCODE_VerTboxOSID		 =	24,//TBox_OS版本
	ACPSIGNCODE_VerTboxMCUID	=	25,	//TBox_MCU版本
	ACPSIGNCODE_VerTboxBLEID	=	26,	//TBox_BLE版本
#ifdef CAR_GW_NODE_MISS
	ACPSIGNCODE_GwNodeMissID	=	27,	//节点是否丢失
#endif
#ifdef MODULE_SIGNAL_VALUE
	ACPSIGNCODE_4GSIGNALVALUEID = 	28,	//4G信号强度值
#endif

	ACPSIGNCODE_CARTYPEID       =   29, // car type
	ACPSIGNCODE_ICCID           =   30,
	ACPSIGNCODE_RentModeID      =   31,
	ACPSIGNCODE_GPSDeatilID           =   32,

	ACPSIGNCODE_LTAverageSpeedID= 	55,	//长时平均车速
	ACPSIGNCODE_STAverageSpeedID= 	56,	//短时平均车速
	ACPSIGNCODE_LTAverageOilID	= 	57,	//长时平均油耗
	ACPSIGNCODE_STAverageOilID	= 	58,	//短时平均油耗
	ACPSIGNCODE_TyreStateID		=714,	//轮胎信息
	ACPSIGNCODE_WheelStateID	=	217,	//实时方向盘转角信息
	ACPSIGNCODE_PastRecordSpeedID	  =	218,	//历史车速
	ACPSIGNCODE_PastRecordWheelStateID=	219,	//历史方向盘转角
	ACPSIGNCODE_ParkingStateID	=	223,	//电子驻车状态
	ACPSIGNCODE_RemainUpkeepMileageID=	226,//剩余保养里程
	ACPSIGNCODE_AirconditionerInfoID =	227,//空调相关信息
	ACPSIGNCODE_KeepingstateTimeID	 =	228,//持续时间信息
	ACPSIGNCODE_VerIVIID		 = 	232,//IVI版本号
	ACPSIGNCODE_AcceleraPedalSwitchID=	235,//加速踏板开关
	ACPSIGNCODE_YaWSensorInfoSwitchID= 	236,//Yaw传感器信息
	ACPSIGNCODE_AmbientTemperatID	 = 	237,//环境温度
	ACPSIGNCODE_PureElecRelayID	 = 	238,//纯电动继电器及线圈相关状态
	ACPSIGNCODE_NewEnergyHeatManageID= 	240,//新能源热管理相关请求
	ACPSIGNCODE_VehWorkModeID	 	= 	241,//车辆工作模式
	ACPSIGNCODE_HighVolageStateID	 = 243,//高压系统准备状态 
}AcpSignCodeID_E;
...
typedef enum
{
	...
	VehicleBody_LockID 			= 	1,	
	VehicleBody_TrackingCarID	=	2,	
	Power_SwitchID 				= 	3,	
    	EngineState_SwitchID 		= 	4,	
	SleepTime_ID                =   5,  
	SleepNow_ID                 =   6,  
	ReportTime_ID               =   7,  
	CheckBleState_ID            =   8,  
	...
	UploadGPSInfo_ID			= 	19,
   	DropOffCar_ID			= 	20,
	SetUpdateTokenTime_ID			= 	21,
	
    	VehicleBody_SunroofID 		= 	99,	
    
	VehicleBody_LowbeamID		=	55,	
	VehicleBody_LuggageCarID	=	66,	
	Airconditioner_ControlID 			= 	30,	
    	Airconditioner_CompressorSwitchID 	= 	31,	
    	Airconditioner_TemperatureID 		= 	32,	
    	Airconditioner_SetAirVolumeID		=	33,	
	Airconditioner_FrontDefrostSwitchID	=	34,	
	Airconditioner_HeatedrearID			=	35,	
	Airconditioner_BlowingModeID		=	36,	
	Airconditioner_InOutCirculateID		=	37,	
	Airconditioner_AutoSwitchID			=	38,
	
	VehicleSeat_DrivingSeatID 		= 	40,	
	VehicleSeat_CopilotseatID		= 	41,	
	VehicleSeat_DrivingSeatMomeryID	=	42,	
	
	VehicleChargeMode_ImmediateID 	= 	50,	
	VehicleChargeMode_AppointmentID	= 	51,	
	VehicleChargeMode_EmergencyCharg =  52,	
	
	VehicleWIFIStatusID				= 	60,	//
	VehicleAutoOUTID				=	61,	
	
	FeatureConfig_StateID			=	255,
	VehicleBody_WindowID 		= 	98,	
}SubitemCode_E;
...
typedef struct
{
	uint8_t	PowerState_Switch;//动力有无
}PowerStateList_t;
//座椅
typedef struct
{
...
typedef struct
{
	...
	PowerStateList_t		PowerState;     //动力数据
...
typedef union
{
	...
	struct{
		...
		uint8_t 	leftlights	    :1;	//后雾灯状态
		uint8_t 	rightlights		:1;	//后雾灯状态
...
typedef struct
{
	...
	uint16_t			RemaineCarOil;	//剩余汽车油量
	uint16_t			RemaineBattery;	//剩余电量
	...
	uint8_t 			EcEngineState;	//电动机状态(0x0关闭,0x1起动机拖动,0x2发动机运行,0x3正在停机,0x4-0x6保留,0x7无效)
	uint16_t			EcEngineSpeed;	//电动机转速
	...
	uint8_t 			PowerState;			//动力状态
	uint8_t 			CarIDState;			//car type
#ifdef CAR_GW_NODE_MISS
	uint8_t 			CarGwNodeMiss		;//car gw Node Miss
#endif
	...
	uint8_t			Tboxersion[14];		//TBox_OS版本
	uint8_t			Hardversion[7];		//TBox_OS版本
	uint8_t			TboxSystem[13];		//TBox_OS版本
	uint8_t			RentInfo;		//TBox_OS版本
	uint8_t			GPSDetailInfo[50];		//TBox_OS版本
}VehicleCondData_t;
...
typedef struct
{
	...
	uint8_t		URL_IP[MAX_UPGRADEPARAM_LEN];			//URL地址(ASCII码)
	char		URL_Port[MAX_UPGRADEPARAM_LEN];			//URL地址(ASCII码)
